...
public class MainFrame extends javax.swing.JFrame implements
	...
	private void initComponents() {
		...
		jLabel2
				.setText("Login Params: Put param names in the first row and values follow rows");
		...
		pnlTableLayout.setHorizontalGroup(pnlTableLayout.createParallelGroup(
				...
				jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 944,
				Short.MAX_VALUE));
		pnlTableLayout.setVerticalGroup(pnlTableLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 264,
				Short.MAX_VALUE));
		...
		try {
			...
			for (int j = 0; j < cookies.length; j++) {
				for (int i = j + 1; i < cookies.length; i++) {
					if (new Integer(cookies[i].length()).compareTo(cookies[j]
							.length()) > 0) {
						String t = cookies[j];
						cookies[j] = cookies[i];
						cookies[i] = t;
